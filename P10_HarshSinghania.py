...
SSW 540 - P10: Data Visualization
CWID - 20007289

Writing a python script to find emails in a text file sent on a per day basis and
plotting a bar chart using Matplotlib module in python.
...
def main():
	...
	for i in val:
		i = val
		j = keys
		plt.bar(j, i, align='center', alpha=0.5, color = 'blue')
